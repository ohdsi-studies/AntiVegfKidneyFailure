...
The PatientLevelPrediction and Cyclops packages in HADES will be used to construct logistic regression models with LASSO regularization to predict the risk of kidney failure ??? months to ??? months after the initial 3 monthly intravitreal anti-VEGF medications.​34​ The model will be developed on 75% of the data and internally validated on the remaining 25%.
